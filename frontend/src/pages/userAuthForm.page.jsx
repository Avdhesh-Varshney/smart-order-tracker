...
const UserAuthForm = ({ type }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!passwordRegex.test(password)) {
            return toast.error("Password must be 8-20 characters long and contain at least one uppercase letter, one lowercase letter, and one number");
        }
    ...
    return (
        <section className="py-4 px-[5vw] md:px-[7vw] lg:px-[10vw] min-h-screen flex items-center justify-center">
            ...
            <form className="w-[80%] max-w-[400px]" id="formElement" onSubmit={handleSubmit}>
